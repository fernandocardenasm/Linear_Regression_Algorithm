...
title ('J(Theta) For Different Alphas.');
h = legend ({'Alpha=0.1', 'Alpha=0.3', 'Alpha=0.01'});
...
price = round([1, size_norm, rooms_norm] * theta); % You should change this
...
price = round([1, 1650, 3] * theta); % You should change this
